 ...
 /** 
    ...
    public Command buildScoringSequence(){
        return new SequentialCommandGroup(
            ...
            new RunCommand(()->{drivetrain.driveArcade(aprilTag.movespeed, 0);}, drivetrain).withTimeout(5),
            new InstantCommand(() -> {aprilTag.isDrive = false;}, aprilTag),
            new InstantCommand(() -> {drivetrain.setBrakeMode(true);}, drivetrain),
            new InstantCommand(() -> {aprilTag.isAlign = true;}, aprilTag),
            new RunCommand(() -> {drivetrain.driveArcade(0, aprilTag.turnSpeed);}, drivetrain).withTimeout(1.75),
            new InstantCommand(() -> {aprilTag.isAlign = false;}, aprilTag),
            new InstantCommand(() -> {drivetrain.setBrakeMode(true);}, drivetrain),
